...
def clear():
    ...
    print()
    print()
    string = "There will be three tries. you will be asked to enter your choice 3 times. Please enter the choice as instructed inside the brackets, as this game code depends on those specific characters, plz... :)"
